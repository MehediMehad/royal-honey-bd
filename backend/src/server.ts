...
import { AnalyticsServices } from './app/modules/analytics/analytics.service';
...
async function main() {
  try {
    ...
    server.listen(port, () => {
      ...
      // Initialize automated growth scheduler for abandoned carts
      AnalyticsServices.initAbandonedCartCron();
